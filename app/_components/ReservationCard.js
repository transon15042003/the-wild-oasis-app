            ...
            <div className="flex flex-col border-l border-primary-800 w-[100px]">
                {!isPast(start_date) ? (
                    <>
                        ...
                        <DeleteReservation booking_id={id} />
                    </>
                ) : (
                    <p className="group flex items-center justify-center uppercase text-xs font-bold text-primary-300 border-b border-primary-800 flex-grow">
                        Done
                    </p>
                )}
            </div>
